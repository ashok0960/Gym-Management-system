  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <img src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=1200&q=80"
        ...
        <div className="relative flex flex-col justify-between p-12 w-full">
          ...
          <div>
            ...
            <h2 className="text-4xl font-black text-white leading-tight mb-4">
              Your Fitness<br /><span className="text-orange-400">Journey Awaits</span>
            </h2>
            ...
            <div className="space-y-4">
              {PERKS.map(({ emoji, text }) => (
                <div key={text} className="flex items-center gap-3">
                  <div className="w-9 h-9 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center text-lg flex-shrink-0">{emoji}</div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-sm">
              ...
              <Link to="/register" className="text-orange-500 font-semibold hover:text-orange-600 transition-colors">Create one free</Link>
            </p>
          </div>
          ...
          <form onSubmit={submit} className="space-y-5">
            <div>
              ...
              <input type="text" required autoComplete="username" placeholder="Enter your username"
